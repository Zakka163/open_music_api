...
module.exports = {
	name: 'playlists',
	version: '1.0.0',
	register: async (server, { playlists_service, playlists_songs_service, songs_service, playlists_song_activities_service, rabbitmq_service, validator, exports_validator }) => {
